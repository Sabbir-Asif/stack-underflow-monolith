...
const ForgotPassword = () => {
    ...
    const handleResetPassword = async (event) => {
        ...
        try {
            await sendPasswordResetEmail(email); // Use the function from AuthContext
            ...
            <div className="hero-content flex-col">
                <div className="max-w-md w-full">
                    <form onSubmit={handleResetPassword} className="flex flex-col gap-4 bg-base-100 p-8 rounded-lg shadow-lg">
                        ...
                        <button 
                            type="submit"
                            className="btn bg-blue-secondary hover:bg-[#86bbd8] text-cream-primary"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                                <>
                        ...
                        <p className="text-center mt-4">
                            ...
                            <Link 
                                to="/sign-in" 
                                className="text-blue-secondary hover:underline font-semibold"
                            >
                                Sign In
                            </Link>
                        </p>
